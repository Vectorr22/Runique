...
import com.vector.test.LocationObserverFake
import com.vector.test.MainCoroutineExtension
import com.vector.test.PhoneToWatchConnectorFake
...
class RunningTrackerTest {
    ...
    fun testCombiningRunData() = runTest {
        runningTracker.runData.test {
            ...
            watchConnectorFake.sendFromWatchToPhone(MessagingAction.HeartRateUpdate(190))
            ...
            assertThat(emission4.heartRates).isEqualTo(listOf(160, 190))
